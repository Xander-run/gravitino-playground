...
cp /tmp/spark/packages/gravitino-spark-connector-runtime-3.4_2.12-0.8.0-incubating-SNAPSHOT.jar /opt/spark/jars/gravitino-spark-connector-runtime-3.4_2.12-0.8.0-incubating-SNAPSHOT.jar
