...
# GRAVITINO_SPARK_CONNECTOR_RUNTIME_JAR="https://repo1.maven.org/maven2/org/apache/gravitino/gravitino-spark-connector-runtime-3.4_2.12/0.8.0-incubating/gravitino-spark-connector-runtime-3.4_2.12-0.8.0-incubating.jar"
...
download_and_verify "${POSTGRESQL_JAR}" "${POSTGRESQL_MD5}" "${spark_dir}"
